...
if __name__ == "__main__":
    ...
    for roh in roh_list: 
        ...
        plt.title("ACO with different pheromone persistence constant (roh)")
    ...
    for q0 in q0_list: 
        ...
        plt.plot(x, best_solution_per_itr)
        plt.title("ACO with different state transition control parameter (q0)")
        plt.xlabel("Iteration")
        plt.ylabel("best solution cost per iteration")
    ...
    for ant_count in ant_count_list: 
        ...
        plt.plot(x, best_solution_per_itr)
        plt.title("ACO with different state population size parameter (# of ants)")
        plt.xlabel("Iteration")
        plt.ylabel("best solution cost per iteration")
